...
internal class AnimationHandler(
    ...
    var isAnimating = false
        private set
    private var compactCalendarAnimationListener: CompactCalendarView.CompactCalendarAnimationListener? =
        null

    private val targetGrowRadius: Int
        get() {
            val heightSq =
                compactCalendarController.targetHeight * compactCalendarController.targetHeight
    ...
    companion object {
        ...
        private val HEIGHT_ANIM_DURATION_MILLIS = 650
        private val INDICATOR_ANIM_DURATION_MILLIS = 600
    }
}
